...
import com.hjsoft.affdelstaffdelapp.fragment.TransferItemsFragment;
 ...
 */
public class TransferItemsActivity extends AppCompatActivity implements RecyclerAdapter.AdapterCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment fragment=new TransferItemsFragment();
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            case 0:Intent i=new Intent(TransferItemsActivity.this,BookingHistoryActivity.class);
                startActivity(i);
                finish();
                break;
            case 1:
                Intent j=new Intent(TransferItemsActivity.this,TransferItemsActivity.class);
                startActivity(j);
                finish();
                break;
            case 2:
                Intent k=new Intent(TransferItemsActivity.this,ChangePasswordActivity.class);
                startActivity(k);
                finish();
                break;
            case 3:
                Intent o=new Intent(TransferItemsActivity.this,MainActivity.class);
                startActivity(o);
                finish();
                break;
           /* case 4:
